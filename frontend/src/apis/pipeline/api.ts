...
export const PipelineServiceApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listPipelineVersions(resource_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION', resource_key_id?: string, page_size?: number, page_token?: string, sort_by?: string, filter?: string, options: any = {}): FetchArgs {
            const localVarPath = `/apis/v1beta1/pipeline_versions`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const PipelineServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listPipelineVersions(resource_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION', resource_key_id?: string, page_size?: number, page_token?: string, sort_by?: string, filter?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiListPipelineVersionsResponse> {
            const localVarFetchArgs = PipelineServiceApiFetchParamCreator(configuration).listPipelineVersions(resource_key_type, resource_key_id, page_size, page_token, sort_by, filter, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const PipelineServiceApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        listPipelineVersions(resource_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION', resource_key_id?: string, page_size?: number, page_token?: string, sort_by?: string, filter?: string, options?: any) {
            return PipelineServiceApiFp(configuration).listPipelineVersions(resource_key_type, resource_key_id, page_size, page_token, sort_by, filter, options)(fetch, basePath);
        },
        /**
         * 
         * @param {string} [page_token] 
...
export class PipelineServiceApi extends BaseAPI {
     ...
     * @memberof PipelineServiceApi
     */
    public listPipelineVersions(resource_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION', resource_key_id?: string, page_size?: number, page_token?: string, sort_by?: string, filter?: string, options?: any) {
        return PipelineServiceApiFp(this.configuration).listPipelineVersions(resource_key_type, resource_key_id, page_size, page_token, sort_by, filter, options)(this.fetch, this.basePath);
    }
