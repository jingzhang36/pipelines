...
export interface ApiPipeline {
    ...
    error?: string;
    /**
     * Output only. The default version of the pipeline. As of now, the latest version is used as default. (In the future, if desired by customers, we can allow them to set default version.) TODO(jingzhang36): expose this in API pipeline definition with FE changes.
...
export const PipelineServiceApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createPipelineVersion(body: ApiPipelineVersion, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling createPipelineVersion.');
            }
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"ApiPipelineVersion" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(body || {}) : (body || "");
        ...
        deletePipelineVersion(version_id: string, options: any = {}): FetchArgs {
            ...
            if (version_id === null || version_id === undefined) {
                throw new RequiredError('version_id','Required parameter version_id was null or undefined when calling deletePipelineVersion.');
            }
            const localVarPath = `/apis/v1beta1/pipeline_versions/{version_id}`
        ...
        getPipelineVersion(version_id: string, options: any = {}): FetchArgs {
            // verify required parameter 'version_id' is not null or undefined
            if (version_id === null || version_id === undefined) {
                throw new RequiredError('version_id','Required parameter version_id was null or undefined when calling getPipelineVersion.');
            }
            const localVarPath = `/apis/v1beta1/pipeline_versions/{version_id}`
                .replace(`{${"version_id"}}`, encodeURIComponent(String(version_id)));
            const localVarUrlObj = url.parse(localVarPath, true);
         ...
         * @throws {RequiredError}
         */
        listPipelineVersions(resource_key_id: string, resource_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION', page_size?: number, page_token?: string, sort_by?: string, filter?: string, options: any = {}): FetchArgs {
            // verify required parameter 'resource_key_id' is not null or undefined
            if (resource_key_id === null || resource_key_id === undefined) {
                throw new RequiredError('resource_key_id','Required parameter resource_key_id was null or undefined when calling listPipelineVersions.');
            }
            const localVarPath = `/apis/v1beta1/pipeline_versions/pipeline/{resource_key.id}`
                .replace(`{${"resource_key.id"}}`, encodeURIComponent(String(resource_key_id)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const PipelineServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createPipelineVersion(body: ApiPipelineVersion, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiPipelineVersion> {
            const localVarFetchArgs = PipelineServiceApiFetchParamCreator(configuration).createPipelineVersion(body, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        deletePipelineVersion(version_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = PipelineServiceApiFetchParamCreator(configuration).deletePipelineVersion(version_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getPipelineVersion(version_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiPipelineVersion> {
            const localVarFetchArgs = PipelineServiceApiFetchParamCreator(configuration).getPipelineVersion(version_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        listPipelineVersions(resource_key_id: string, resource_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION', page_size?: number, page_token?: string, sort_by?: string, filter?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiListPipelineVersionsResponse> {
            const localVarFetchArgs = PipelineServiceApiFetchParamCreator(configuration).listPipelineVersions(resource_key_id, resource_key_type, page_size, page_token, sort_by, filter, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const PipelineServiceApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        createPipelineVersion(body: ApiPipelineVersion, options?: any) {
            return PipelineServiceApiFp(configuration).createPipelineVersion(body, options)(fetch, basePath);
        },
        /**
         * 
         * @param {string} id 
        ...
        deletePipelineVersion(version_id: string, options?: any) {
            return PipelineServiceApiFp(configuration).deletePipelineVersion(version_id, options)(fetch, basePath);
        },
        /**
         * 
         * @param {string} id 
        ...
        getPipelineVersion(version_id: string, options?: any) {
            return PipelineServiceApiFp(configuration).getPipelineVersion(version_id, options)(fetch, basePath);
        },
        /**
         * 
         * @param {string} id 
         ...
         * @throws {RequiredError}
         */
        listPipelineVersions(resource_key_id: string, resource_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION', page_size?: number, page_token?: string, sort_by?: string, filter?: string, options?: any) {
            return PipelineServiceApiFp(configuration).listPipelineVersions(resource_key_id, resource_key_type, page_size, page_token, sort_by, filter, options)(fetch, basePath);
        },
        /**
         * 
         * @param {string} [page_token] 
...
export class PipelineServiceApi extends BaseAPI {
    ...
    public createPipelineVersion(body: ApiPipelineVersion, options?: any) {
        return PipelineServiceApiFp(this.configuration).createPipelineVersion(body, options)(this.fetch, this.basePath);
    }
    ...
    public deletePipelineVersion(version_id: string, options?: any) {
        return PipelineServiceApiFp(this.configuration).deletePipelineVersion(version_id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof PipelineServiceApi
     */
    public listPipelineVersions(resource_key_id: string, resource_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION', page_size?: number, page_token?: string, sort_by?: string, filter?: string, options?: any) {
        return PipelineServiceApiFp(this.configuration).listPipelineVersions(resource_key_id, resource_key_type, page_size, page_token, sort_by, filter, options)(this.fetch, this.basePath);
    }
