...
def datahtml(
    ...
    import os
    image_path = os.path.join('gs://', 'jingzhangjz-project-outputs', 'visualization.png')
    image_url = os.path.join('https://storage.googleapis.com', 'jingzhangjz-project-outputs', 'visualization.png')
    html_path = os.path.join('gs://', 'jingzhangjz-project-outputs', 'kaggle.html')
