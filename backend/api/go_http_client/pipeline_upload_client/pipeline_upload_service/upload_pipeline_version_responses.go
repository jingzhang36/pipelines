...
func (o *UploadPipelineVersionOK) Error() string {
	return fmt.Sprintf("[POST /apis/v1beta1/pipeline_versions/upload][%d] uploadPipelineVersionOK  %+v", 200, o.Payload)
}
...
func (o *UploadPipelineVersionDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v1beta1/pipeline_versions/upload][%d] UploadPipelineVersion default  %+v", o._statusCode, o.Payload)
}
